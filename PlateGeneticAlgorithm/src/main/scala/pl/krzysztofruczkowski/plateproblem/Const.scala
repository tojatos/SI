...
object Const {
  ...
  val GENERIC_OPTIMIZER_POPULATION_SIZE = 500
  val GENERIC_OPTIMIZER_CROSS_PROBABILITY = 0.2
  val GENERIC_OPTIMIZER_MUTATION_PROBABILITY = 0.9
...
//  val OPERATOR = new RouletteSelectionOperator(new Random())
  ...
  val RESEARCH_ITERATIONS = 1500
  val RESEARCH_TIMES = 10
